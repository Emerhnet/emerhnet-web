...
const HospitalAuditLogPage = lazy(() => import('@/features/hospital-admin/audit-log/AuditLogPage'));
const HospitalExportsPage = lazy(() => import('@/features/hospital-admin/exports/ExportsPage'));

const AuditLogPage = lazy(() => import('@/features/super-admin/audit-log/AuditLogPage'));
const ExportsPage = lazy(() => import('@/features/super-admin/exports/ExportsPage'));
