...
export function SetPasswordPage() {
  ...
  return (
    <PublicShell showHeaderActions>
      <Typography variant="h2" sx={{ fontSize: 20, fontWeight: 600, color: 'primary.main', mb: 0.5 }}>
        Set a new password
      </Typography>
      ...
      <form onSubmit={onSubmit} noValidate>
        <div className="mb-1">
          <Typography component="label" htmlFor="newPassword" variant="body2" sx={{ fontWeight: 500 }}>
        ...
        >
          ...
          <CheckItem ok={checks.notCompromised} label="Not commonly compromised" />
        </Box>
