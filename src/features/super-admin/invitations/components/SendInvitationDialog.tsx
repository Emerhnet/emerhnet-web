...
export function SendInvitationDialog({
  ...
  const handleConfirm = () => {
    onConfirm({ hospitalName, recipientEmail, recipientRole, internalNotes, verificationNotes });
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <IconButton onClick={handleCancel} size="small" sx={{ mt: -0.5, mr: -0.5 }}>
      ...
      <DialogContent sx={{ px: 3, py: 3 }}>
        ...
        >
          ...
          <Typography variant="body2" sx={{ color: 'text.secondary', mb: 2 }}>
            Confirm offline verification before sending. This record is stored in the audit log.
          </Typography>
          ...
          >
            ...
            <Typography
              variant="caption"
              sx={{ fontWeight: 600, color: 'text.secondary', whiteSpace: 'nowrap', minWidth: 36 }}
            >
            ...
            {CHECKLIST_ITEMS.map((text, i) => (
              <FormControlLabel
                ...
                sx={{
                  ...
                  mx: 0,
                  py: 0.25,
                  '& .MuiFormControlLabel-label': { fontSize: 13, lineHeight: 1.5, pt: '7px' },
                }}
                control={
                  <Checkbox
                    size="small"
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2 }}>
          ...
          <TextField
            ...
            helperText={recipientEmail.length > 0 && !emailValid ? 'Enter a valid email' : ' '}
            fullWidth
          />
          <TextField
      ...
      <DialogActions sx={{ px: 3, py: 2 }}>
        <Button variant="outlined" onClick={handleCancel} disabled={submitting} sx={{ fontWeight: 600 }}>
          Cancel
        </Button>
        <Button
          variant="contained"
