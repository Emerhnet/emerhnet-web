  ...
  return (
    <Box sx={{ textAlign: "center", py: 1 }}>
      ...
      >
        {wasInvited ? (
          <>
            Your hospital has been activated. We&apos;ve emailed login
            credentials to <strong>{adminEmail}</strong>. Use them to sign in
            and set a new password.
          </>
        ) : (
          <>
            Thank you. The Galas team will review your application and respond
            within 3 business days. We&apos;ve sent a confirmation to{" "}
            {adminEmail}.
          </>
        )}
      </Typography>
